...
***Phiên bản thường***
```
bash <(curl -Ls https://raw.githubusercontent.com/Dangvantuanht/XrayR-release/main/install.sh)
```
***Phiên bản pro***
```
bash <(curl -Ls https://raw.githubusercontent.com/Dangvantuanht/XrayR-release/main/XrayR_Pro.sh)
```
## Cấu hình xrayr
