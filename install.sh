...
install_XrayR() {
    ...
    file="https://github.com/Dangvantuanht/XrayR-release/blob/main/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://github.com/Dangvantuanht/XrayR-release/blob/main/XrayR.sh
